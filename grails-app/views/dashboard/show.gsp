...
<html>
    ...
    <body>
        ...
        <div id="show-dashboard" class="content scaffold-show" role="main">
            ...
            <f:display bean="dashboard" />
            <g:form resource="${this.dashboard}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.dashboard}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
